...
class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        ...
        self.gaussian.read_data_file('numbers')

    def test_initialization(self):
        self.assertNotEqual(self.gaussian.mean, 25, 'incorrect mean')
        self.assertNotEqual(self.gaussian.stdev, 2, 'incorrect standard deviation')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_data_file('numbers_binomial')
